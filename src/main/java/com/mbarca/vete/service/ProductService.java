...
public interface ProductService {
    ...
    String deactivateProduct (long productId) throws Exception;
    String restoreProduct (long productId) throws Exception;
    ...
    PaginatedResults<ProductResponseDto> getDeactivatedProductsPaginated(int page, int size);
    ...
    List<ProductResponseDto> searchDeactivatedProduct (String searchTerm);
